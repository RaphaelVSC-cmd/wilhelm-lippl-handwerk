# Projekt-Aufgabenplan: Wilhelm Lippl (Handwerk)
*V3.1 – MotionSites Edition*

---

## Phase 1: THINK (Analyse & Spezifikation)
- [x] Unternehmensdaten & Google-Maps-Details analysiert (Regensburger Str. 210, Ingolstadt, 5.0⭐, Willi Lippl)
- [x] USPs aus echten Bewertungen extrahiert (Willi sympathisch/gut gelaunt, leistbare Handwerkspreise, Mutter immer erreichbar)
- [x] `docs/prd.md` erstellt

## Phase 2: PLAN (Design-System & Architektur)
- [x] Vibe-Archetype gewählt: Craft Warmth & Ethereal Amber-Glass
- [x] Header-Pattern gewählt: Fluid Island Navbar (Variante A)
- [x] Alleinstellungsmerkmale definiert: Sticky 3D Card-Stacking (§ 15), 3D Tilt (§ 0A #8), Zähler-Stats (§ 0A #6), Char-Reveal (§ 17)
